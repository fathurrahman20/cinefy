      ...
      <div className="flex flex-col h-full max-h-screen gap-2">
        ...
        <div className="flex-1">
          <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
            ...
            <Link
              to="/admin/genres"
              className={`flex items-center gap-3 px-3 py-2 transition-all rounded-lg text-muted-foreground ${
            ...
            <Link
              to="/admin/theaters"
              className={`flex items-center gap-3 px-3 py-2 transition-all rounded-lg text-muted-foreground ${
                pathname.includes("/admin/theaters")
                  ? "bg-primary text-primary-foreground hover:text-primary-foreground"
                  : "hover:text-primary"
              }`}>
            ...
            <Link
              to="/admin/movies"
              className={`flex items-center gap-3 px-3 py-2 transition-all rounded-lg text-muted-foreground ${
                pathname.includes("/admin/movies")
                  ? "bg-primary text-primary-foreground hover:text-primary-foreground"
                  : "hover:text-primary"
              }`}>
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2 transition-all rounded-lg text-muted-foreground ${
                pathname.includes("/admin/wallet-transactions")
                  ? "bg-primary text-primary-foreground hover:text-primary-foreground"
                  : "hover:text-primary"
              }`}>
